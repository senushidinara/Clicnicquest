...
const Header: React.FC<HeaderProps> = ({ currentView, onNavigate, score, levelName, userAvatar }) => {
  return (
    <header className="w-full py-3 px-4 sm:px-8 border-b border-gray-200/50 bg-white/60 backdrop-blur-lg sticky top-0 z-50">
          ...
          <div className="flex items-center gap-4">
            ...
            <nav className="flex items-center gap-2 pl-4 border-l border-gray-200">
                ...
                <button 
                    ...
                    className={`btn btn-nav ${currentView === 'leaderboard' ? 'active' : ''}`}
